create table if not exists user (id bigint primary key auto_increment,name varchar(100) not null unique ,password varchar(150) not null ,email varchar(100) not null );
create table if not exists message(id bigint primary key auto_increment,message varchar(255),user_id bigint ,foreign key(user_id) references user(id));
